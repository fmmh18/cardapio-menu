...
<?php if($row['category_name'] == $data['category_name']): ?>
    <div class="col-12 shadow-sm p-3 mb-4 bg-white rounded">
        <div class="row">
            ...
            <div class="col-2">
                <input type="number" name="<?php echo $data['product_id']?>" value="0" min="0">
            </div>
        </div>
    </div>
<?php endif;?>
<?php endforeach; ?>
<?php endforeach; ?>
<button type="submit" class="btn btn-danger btn-lg btn-block mb-5"><i class="fas fa-shopping-cart"></i> Ver carrinho</button>
</form>
</div>
</div>
